...
export function useTokenContract(signer) {
	return useContract(Environment.TokenContract, tokenABI, signer);
}
export function useMyContract(signer) {
	return useContract(Environment.TokenContract, contractABI, signer);
}
